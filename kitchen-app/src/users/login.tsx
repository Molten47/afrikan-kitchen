...
const Signin: React.FC = () => {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-light p-4 real-font">
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 real-font">
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="mt-1 md:mt-2 text-[#6B7280] text-sm">Let's get back to business</p>
        </div>
        ...
        <form className="space-y-4 md:space-y-6">
          ...
          <div>
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-cta hover:bg-[#8bb962] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 "
            >
              Log In
            </button>
          </div>
        ...
        <div className="mt-4 md:mt-6 text-center">
          <p className="text-sm text-dark">
            ...
            <Link to="/signup" className="font-medium text-cta hover:text-[#00b5b5]">
              Sign Up
            </Link>
          </p>
        </div>
